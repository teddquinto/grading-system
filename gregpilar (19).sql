...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 14, 2017 at 04:58 PM
...
(24, 'Grade 3', 'Orchids3', '2017-2018', '2017-12'),
...
(2000160, 'BEED', '                                                                          asdsa                                                                                                                          ', '                                                                                                                            ', 'general_education,Math', 'yes'),
...
--
ALTER TABLE `sections`
  MODIFY `sec_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
--
...
--
ALTER TABLE `teachers_class`
  MODIFY `t_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;
--
