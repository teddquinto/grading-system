...
require "required_files.php";
 ...
 $query = "SELECT distinct glevel_section,type_of_teacher FROM teachers_class where teachers_id LIKE '%$teachers_id%' ";    
           ...
           $subject_result = mysqli_query($connect, $find_subject);  
                  ...
                  $find_student="SELECT DISTINCT  SR.studno, SI.lname, SI.fname, SI.mname
               ...
               <div id="content" class="three_quarter"> 
                 ...
                 <td colspan="3"><?php echo $t_type;?></td>  
                  ...
                  <td> <?php echo $row['mname']; ?> </td>          
                   <td><a href="report_form.php?l=<?php echo $lname." ".$fname." ".$mname; ?>&id=<?php echo $row['studno']; ?>&g=<?php echo $g_level;?>&t=<?php echo $t_type;?>"><center><img src="images/add.png" style="width: 70px; height: 40px;" ></center></a> </td>      
                  </tr>
