...
if(!isset($_SESSION["teachers_id"]))  
 ...
 $studno = $_GET['id'];
           ...
           $g_level = "SELECT * FROM g_level GROUP BY g_id  LIMIT $g_id,9";           
...
<body>
    ...
    <SCRIPT language=JavaScript>
     ...
     self.location='samp.php?id=<?php echo $studno; ?>&g_id=' + val ;
     }
...
<div class="wrapper row3">
  <div class="rounded">
    <main class="container clear"> 
            ...
            <form method=post name=f1 action='enroll_student2.php?id=<?php echo $studno; ?>'>
          
                 
            <select class="grade_option"  onchange="reload(this.form)" name="cat">
